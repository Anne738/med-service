...
namespace med_service.Data.Migrations
{
    ...
    [Migration("20250403155344_UpdateApplicationDbContextFix")]
    partial class UpdateApplicationDbContextFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("med_service.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("med_service.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("med_service.Models.Appointment", b =>
                {
                    b.HasOne("med_service.Models.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("med_service.Models.Patient", "Patient")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("med_service.Models.Doctor", b =>
                {
                    b.HasOne("med_service.Models.Hospital", "Hospital")
                        .WithMany("Doctors")
                        .HasForeignKey("HospitalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("med_service.Models.Specialization", "Specialization")
                        .WithMany()
                        .HasForeignKey("SpecializationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("med_service.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("med_service.Models.Patient", b =>
                {
                    b.HasOne("med_service.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("med_service.Models.Patient", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("med_service.Models.TimeSlot", b =>
                {
                    b.HasOne("med_service.Models.Schedule", "Schedule")
