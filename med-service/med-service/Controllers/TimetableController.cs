...
namespace med_service.Controllers
{
    public class TimetablesController : Controller
    {
        ...
        public async Task<IActionResult> Doctor(int id, int? selectedDay)
        {
            ...
            // Якщо день не вибрано, використовуємо перший день з переліку або понеділок за замовчуванням
        ...
        public async Task<IActionResult> Book(string day, int hour, int minute, int doctorId)
        {
            ...
            // Отримуємо розклад для вказаного дня та лікаря
            ...
            if (schedule == null)
            {
                // Якщо розклад не існує, створюємо новий
            ...
            if (slot.isBooked)
            {
                // Якщо слот вже зайнятий, не даємо записуватися
                TempData["Error"] = "Вибачте, цей часовий слот вже заброньовано";
                return RedirectToAction("Doctor", new { id = doctorId });
            }
